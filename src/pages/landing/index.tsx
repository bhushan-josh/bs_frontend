        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            {/* <div className="hidden lg:flex lg:ml-16 lg:items-center lg:justify-center lg:space-x-10">
              ...
              <a href="#" className="text-base font-medium text-gray-900 transition-all duration-200 rounded hover:text-opacity-50 focus:ring-1 focus:ring-gray-900 focus:ring-offset-2">
                Login
              </a>
              <a
                href="#"
